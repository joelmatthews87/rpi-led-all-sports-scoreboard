...
class NHLGamesScene(GamesScene):
    ...
    def display_scene(self):
        ...
        if display_yesterday:
            if (hasattr(self, 'data_previous_day') and self.data_previous_day['saved_date'] != dates_to_display[0]) or not hasattr(self, 'data_previous_day'):
                self.data_previous_day = {
                    ...
                    'games': data.nhl_data.get_games(dates_to_display[0], include_preseason) # Get data for previous date.
                }
        ...
        self.data = {
            ...
            'games': data.nhl_data.get_games(dates_to_display[-1], include_preseason), # Get data for current day. Current day will always be the last element of dates_to_display.
        }
